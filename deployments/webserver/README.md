...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `admin-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `admin-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `admin-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `admin.sdkwork.com` | 443 ssl + 80 |
