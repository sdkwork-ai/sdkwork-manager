...
Module `sdkwork-manager` · runtime code `manager` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `admin-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `admin-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `admin-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `admin-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `admin.sdkwork.com` | 443 ssl + 80 |
